---
title: "INFO 523 Syllabus Spring 2024"
format: 
  html: default
  pdf: default
---
...
\_\_\_ INFO 523 001 - Data Mining and Discovery
...
Live in-person lectures, W 1:00-3:30pm,Henry Koffler, RM 216. Attendance is mandatory.
...
All lecture notes, assignment instructions, an up-to-date schedule, and other course materials may be found on the course website: [datamineaz.org](https://datamineaz.org/).
...
#### Before hw-03 (training wheels on)

I will regrade your homework assignments 1 and 2 once to encourage the correct format for future submissions. Your final score will be the midpoint of the first and second score (e.g., first score: 70%, second score: 100% = final score: 85%). Re-submissions must be received within 1-week of the original grade.

#### From hw-03 and on (training wheels come off)
